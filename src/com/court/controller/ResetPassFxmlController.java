 ...
 * @author Shanaka P
 */
public class ResetPassFxmlController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        FxUtilsHandler.showHidePasswordField(oldpass_field, boxfield_old);
    ...
    public PasswordField getOldpass_field() {
        return oldpass_field;
    }
